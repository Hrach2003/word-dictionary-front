    ...
    <div className="w-1/2 px-1 mb-2">
      <div onClick={() => history.push(`/word/${word.word}`)} className="rounded-md flex flex-col bg-gradient-to-t from-green-200 via-gray-200 to-gray-100 h-20 shadow-sm relative z-10 group">
        <span onClick={(e) => {
          e.stopPropagation()
          read()
        }} className="bg-gray-700 cursor-pointer text-white rounded-full w-6 h-6 absolute top-0 right-0 m-1 flex items-center justify-center opacity-100 md:opacity-50 group-hover:opacity-100">
